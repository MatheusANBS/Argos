...
description: Dependências reproduzíveis para o projeto Argos Runtime Memory MCP.
---

# Dependências reproduzíveis

Antes de adicionar dependência, registre versão, origem, licença, hash/lock, política de atualização, threat model e fallback. Prefira biblioteca padrão e componentes vendorizados pequenos quando reduzirem supply-chain sem aumentar risco de manutenção. Dependências devem ser isoladas da API pública.
