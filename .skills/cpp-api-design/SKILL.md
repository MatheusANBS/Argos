---
name: cpp-api-design
description: Design de APIs C++ para o projeto Argos Runtime Memory MCP.
---

# Design de APIs C++

Modele contratos, invariantes, lifetime, erros e misuse resistance antes de implementar. Use struct para dados simples e class para proteger invariantes. Não exponha tipos de JSON, handles nativos ou detalhes de dependências nas interfaces de domínio. Mantenha compatibilidade e ownership explícitos.
